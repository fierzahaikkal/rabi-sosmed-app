...
const people = [
  {
    ...
    topic: 'sports',
    content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore, sapiente possimus dicta est reprehenderit corrupti labore saepe nulla iure recusandae, atque error aperiam perspiciatis pariatur, nobis alias nemo quo incidunt.",
    imageContent:
...
function profilepost() {
  ...
  return (
    <main>
      ...
      <ul role="list" className="divide-y divide-black-100 mb-5">
      {peopleData.map((person, index) => (
        <li key={person.username} className="flex flex-col justify-between gap-x-6 py-5">
          ...
          <div className='flex gap-2'>
              <p className="mt-1 text-xs leading-5 text-gray-500">{person.content}
              <img className='rounded mt-2' src={person.imageContent} alt="" />
